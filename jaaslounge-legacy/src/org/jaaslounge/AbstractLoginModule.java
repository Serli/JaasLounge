...
public abstract class AbstractLoginModule implements LoginModule, Authenticator {
   ...
   protected static final int TOMCAT=0;
    ...
    private Set principals=new java.util.HashSet();
	private Set publicCredentials=new java.util.HashSet();
	private Set privateCredentials=new java.util.HashSet();    
    ...
    public void initialize(Subject subject, CallbackHandler callbackHandler, Map sharedState, Map options) {    
		...
		printDebug("JaasLounge version: "+Version.TAG);
		
		String modeName=(String) (getOptions().get("mode"));
		printDebug("mode: "+modeName);
    ...
    public boolean login() throws LoginException {
		...
		printDebug("user entered username: "+username);
		printDebug("user entered password: ***"/*+new String(password)*/);
		
		try {
			authenticate();				
		    succeeded = true;
		    
		    printDebug("authentication succeeded");
    ...
    public void setPrincipalsAndCredentials() {	
		...
		case JETTY:
			...
			GroupPrincipal groupRoles=new GroupPrincipal(getMode()==JBOSS ? "Roles" : "__roles__");
			// GroupPrincipal groupCallerPrincipal=new GroupPrincipal("CallerPrincipal");
		...
		if (succeeded == false) {
			...
			(new java.security.PrivilegedAction() {
				public Object run() {		  
					...
					// TODO : voir pb ajout de collection de role au lieu de fusion
		    ...
		    printDebug("Principals & credentials set for Subject");
